        ...
        <div className="max-w-2xl">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-300 mb-10 leading-relaxed">
              We are a Pan-African community of about 1000+ nurses across  countries and the diaspora, united by one mission: connecting expertise with communities that need it most.
            </p>
